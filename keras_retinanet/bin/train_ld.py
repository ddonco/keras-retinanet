...
def create_generators(args, preprocess_image):
    ...
    if args.random_transform:
        ...
        transform_generator = random_transform_generator(min_translation=(-0.01, -0.01),
                                                         max_translation=(0.01, 0.01))
...
def main(args=None):
    ...
    # def preprocess_image(inputs, mode='pass'):
    #     """ Takes as input an image and prepares it for being passed through the network.
    #     """
    #     return preprocess_image(inputs, mode=mode)

    # backbone.preprocess_image = preprocess_image
    ...
    train_generator, validation_generator = create_generators(
        args, lambda mode='pass': backbone.preprocess_image(mode))
